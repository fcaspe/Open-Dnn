...
void sub_net_0(  
        ...
        data_type_itf data_in_0[103058],
        data_type_itf data_out_0[24200],
        data_type_itf data_in_1[24200],
...
#pragma HLS INTERFACE m_axi port=data_in_0 offset=slave depth=103058 bundle=DATA_IN     
...
#pragma HLS INTERFACE bram port=data_out_1        
	...
	if (select == 0)
	{
		...
		acc1_mem_inport_offset = 12100;
		acc1_mem_outport_offset = 7290;
	}
	else
	{
		acc0_mem_inport_offset = 51529;
		acc0_mem_outport_offset = 12100;
...
#pragma HLS INTERFACE bram port=data_out_1        
    ...
    conv_pool_acc_3(param_port + 0,       
                //bias_in,       
                weight_in,  
                data_in_0 + acc0_mem_inport_offset,  
                data_out_0 +acc0_mem_outport_offset); 
    
    conv_pool_acc_4(param_port + 512,       
                //bias_in,       
                weight_in,  
                data_in_1 + acc1_mem_inport_offset,  
                data_out_1 +acc1_mem_outport_offset); 
