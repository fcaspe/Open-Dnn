...
if { $list_projs eq "" } {
   create_project -force $proj_name $proj_path -part xcvu9p-flga2104-2L-e
...
proc create_and_assign_pblocks {} {
  ...
  resize_pblock pblock_slr0 -add CLOCKREGION_X0Y0:CLOCKREGION_X5Y4
  endgroup

  # draw pblock slr1 
  startgroup 
  create_pblock pblock_slr1
  resize_pblock pblock_slr1 -add CLOCKREGION_X0Y5:CLOCKREGION_X5Y9
  endgroup

  # draw pblock slr2 
  startgroup 
  create_pblock pblock_slr2
  resize_pblock pblock_slr2 -add CLOCKREGION_X0Y10:CLOCKREGION_X5Y14
  endgroup
