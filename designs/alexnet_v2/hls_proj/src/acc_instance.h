...
void conv_layer_acc_0(
	    ...
	    convAcc0.conv_layer_acc_mbuf(N, K, M, R_IN, C_IN, C_OUT, R_OUT, S, P, act, inport, weight_offset, bias_offset, in_offset, out_offset, i_weight, i_data, out_data);
	};

conv_acc< data_type_itf, Tparam, data_type, data_type_w, data_type_o, 128, 11, 27, 27, 5, 5, 32, 32, 32> convAcc1;
...
void conv_layer_acc_2(
	    ...
	    convAcc2.conv_layer_acc_mbuf(N, K, M, R_IN, C_IN, C_OUT, R_OUT, S, P, act, inport, weight_offset, bias_offset, in_offset, out_offset, i_weight, i_data, out_data);
	};

conv_acc< data_type_itf, Tparam, data_type, data_type_w, data_type_o, 64, 17, 13, 13, 5, 5, 32, 32, 32> convAcc3;
...
max_pool_acc< data_type_itf, Tparam, data_type, data_type_w, data_type_o, 32, 16, 16, 2, 3> maxPoolAcc2;
...
void max_pool_layer_acc_2(
		...
		data_type_itf* i_data,
		data_type_itf* o_data){
		    maxPoolAcc2.max_pool_layer_mbuf(R_in, C_in, N, K, R, C, S, P, act, i_offset, o_offset, i_data, o_data);
		};
...
void conv_pool_acc_2(
	   ...
	   )
	{
	    ...
	    for (unsigned int l = 0; l < layer_num_local[0]; l++) {
	        ...
	        {
	            cout << "LAYER ACC: Execute conv layer without pool, enable_pool =  " << param_pool_local[15] << endl;
	            conv_layer_acc_2(param_conv_local[0], // N
	                         param_conv_local[1], // K
	                         param_conv_local[2], // M
	                         param_conv_local[3], // Rin
	                         param_conv_local[4], // C
...
void conv_pool_acc_3(
	   ...
	   )
	{
	    ...
	    for (unsigned int l = 0; l < layer_num_local[0]; l++) {
	        ...
	        {
	            cout << "LAYER ACC: Execute conv layer without pool, enable_pool =  " << param_pool_local[15] << endl;
	            conv_layer_acc_3(param_conv_local[0], // N
	                         param_conv_local[1], // K
	                         param_conv_local[2], // M
	                         param_conv_local[3], // Rin
	                         param_conv_local[4], // C
...
void conv_pool_acc_4(
	   ...
	   )
	{
	    ...
	    for (unsigned int l = 0; l < layer_num_local[0]; l++) {
	        ...
	        {
	            cout << "LAYER ACC: Execute conv layer without pool, enable_pool =  " << param_pool_local[15] << endl;
	            conv_layer_acc_4(param_conv_local[0], // N
	                         param_conv_local[1], // K
	                         param_conv_local[2], // M
	                         param_conv_local[3], // Rin
	                         param_conv_local[4], // C
	        ...
	        {
	            cout << "LAYER ACC: POOL Execute pool layer with pooling enable: " << param_pool_local[15] << endl;
	            max_pool_layer_acc_2(param_pool_local[0], // R_in,
	                           param_pool_local[1], // C_in
	                           param_pool_local[2], // N
	                           param_pool_local[3], // K
	                           param_pool_local[4], // R
